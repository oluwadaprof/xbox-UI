        ...
        <>
            <div className=' overscroll-none bg-gradient-to-r flex gap-20 from-[#252525] to-[#070707]  h-14  w-screen'>
                ...
                <div className='absolute top-0 right-20 mr-56'>
                    ...
                    <input placeholder='search for games' className='absolute top-3 right-0 item-right focus:outline-none placeholder:text-[#979797]  placeholder:scale-[.8] pl-4 rounded-full  w-78 h-7 bg-[#222222]' />
                </div>
